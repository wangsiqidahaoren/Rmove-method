...
To train a model from scratch:
  ...
  * Before training, you can edit the configuration hyper-parameters in the file [config.py](config1.py),
...
These settings can be changed by simply editing the file [config.py](config1.py).
