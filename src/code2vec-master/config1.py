...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        #                     help="path to preprocessed dataset", required=False,default='data/java14m/java14m')
        parser.add_argument("-d", "--data", dest="data_path",
                            help="path to preprocessed dataset", required=False)
        # parser.add_argument("-te", "--test", dest="test_path",
        #                     help="path to test file", metavar="FILE", required=False, default='data/java14m/java14m.val.c2v')
        parser.add_argument("-te", "--test", dest="test_path",
                            help="path to test file", metavar="FILE", required=False)
        # parser.add_argument("-s", "--save", dest="save_path",
        #                     help="path to save the model file", metavar="FILE", required=False,default='models/java14m')
        parser.add_argument("-s", "--save", dest="save_path",
    ...
    def load_from_args(self):
        ...
        self.DL_FRAMEWORK = '' if not args.dl_framework else args.dl_framework
