...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        #开始加载project
        parser.add_argument('-jp', '--java_project', dest='java_project',required=False,
                            help='use tensorboard during training')
        return parser
    ...
    def set_defaults(self):
        ...
        self.TOKEN_EMBEDDINGS_SIZE = 32
        self.PATH_EMBEDDINGS_SIZE = 64
    ...
    def load_from_args(self):
        ...
        #加载配置文件--
        self.JAVA_PROJECT = args.java_project
    ...
    def context_vector_size(self) -> int:
       ...
       # return self.PATH_EMBEDDINGS_SIZE
    @property
